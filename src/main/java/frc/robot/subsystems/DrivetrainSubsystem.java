...
//   public static final double MAX_VOLTAGE = 12.0;
  ...
  // get drivetrain max velocity from the SDS web site
  //  https://www.swervedrivespecialties.com/products/mk4-swerve-module
  //  for NEOs it is 14.5 ft/sec
  public static final double MAX_VELOCITY_METERS_PER_SECOND = 14.5 * 0.3048;
        // comment out SDS code below
